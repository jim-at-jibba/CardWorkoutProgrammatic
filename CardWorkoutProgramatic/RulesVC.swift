...
// Segue only exist in storyboard
class RulesVC: UIViewController {
    ...
    func configureRulesLabel() {
        ...
        rulesLabel.numberOfLines = 0 // automatically adjusts to our content
    ...
    func configureExerciseLabel() {
        ...
        exerciseLabel.numberOfLines = 0 // automatically adjusts to our content
